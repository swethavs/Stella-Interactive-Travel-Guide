...
public class IndividualItemsListView extends LinearLayout {
    ...
    public IndividualItemsListView(Context context, final RadioButtonTracker textSelected) {
        super(context);
        //MainActivity.LOGGER.i(TAG,"Inside IndividualItemInListView view constructor: textselected");
