...
public class MainActivity extends FragmentActivity implements OnMapReadyCallback, LocationListener, TextToSpeech.OnInitListener, View.OnTouchListener {
    ...
    String welcomeSpeechpart1 = "Welcome to Stella, an interactive travel guide assistant. You need to enable the location to access this app.";
    String welcomeSpeechpart2 = "With this app you can find the tourist attractions, restaurants and  gas stations";
